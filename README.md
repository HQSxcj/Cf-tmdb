...
一个基于 **Cloudflare Workers** 的轻量级 TMDB 代理，适合国内环境访问 TMDB，让emby不借助vpn机场节点也能正常刮削图片与元数据。
...
# 注意：设置好的自定义域名代理 因有 cloudflare workers 免费套餐限制，请不要分享代理自定义域名给他人使用，可推荐他人自主安装 worker 使用自己的免费套餐
---
## 如觉得以上太麻烦了，可以手动配置操作
-  1.托管域名到couldflare
...
```
## 注：本仓库玩法由群友摸鱼出来，用ai助手编写代码。本仓库可随意复制，代码可以随意修改创作，随意利用您的想法和专业知识创作代码的功能，本仓库不负责解答任何问题和承担责任。

## 请注意 自主修改创作 需了解 Cloudflare的Workers 的免费套餐限制，防止超过限制 被短暂限制 worker 当天请求，需第二天重置计数后才可重新运行。
